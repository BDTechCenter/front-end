...
export default function NewsCard({ data }: NewsCardProps) {
  ...
  return (
    <Link href={href} className="flex flex-col h-[22rem] gap-2 cursor-pointer group border" onClick={handleClick}>
      ...
      <div className="flex flex-col group-hover:opacity-60 transition-all ml-1">
